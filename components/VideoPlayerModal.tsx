  ...
  return (
    <div className="modal-video-player">
      ...
      <div className="flex justify-between items-center p-4 bg-white border-b sticky top-0 z-20">
        <button 
          onClick={onClose}
          className="w-10 h-10 bg-gray-100 rounded-full text-gray-600 font-bold text-xl"
        >
          ✕
        </button>
        <h2 className="text-lg font-bold text-gray-800 truncate px-2">{video.titulo}</h2>
        <div className="w-10"></div> {/* Spacer */}
      </div>

      {/* VIDEO PLAYER */}
      <div className="video-embed-wrapper sticky top-[73px] z-10">
        <iframe 
